...
namespace RFBCodeWorks.CachedRoboCopy.TestApp
{
    /// <summary>
    ...
    public partial class MainWindow : Window
    {
        ...
        private RoboCopyResultsList SingleJobResults = new RoboCopyResultsList();
        ...
        private void BtnLoadJob_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (JF != null)
                {
                    GenOption_RoboCommand.IsChecked = true;
                    var oldCmd = (RoboCommand)GetCommand(false);
        ...
        private async void BtnSaveJob_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    GenOption_RoboCommand.IsChecked = true;
                    await ((RoboCommand)GetCommand(false)).SaveAsJobFile(FP.FileName, true, true);
                }
                else
                {
        ...
        private void RoboQueue_OnProgressEstimatorCreated(RoboQueue sender, ProgressEstimatorCreatedEventArgs e)
        {
            e.ResultsEstimate.ValuesUpdated += IProgressEstimatorValuesUpdated;
        }

        private void IProgressEstimatorValuesUpdated(IProgressEstimator sender, IProgressEstimatorUpdateEventArgs e)
        {
            Dispatcher.Invoke(() =>
            {
        ...
        /// </summary>
        private void RoboQueue_ListOnlyResultsUpdated(object sender, ResultListUpdatedEventArgs e)
        {
        ...
        /// It had to be done like this due to INotifyCollectionChanged not updating the listbox due to threading issues
        /// </summary>
        private void RoboQueue_RunOperationResultsUpdated(object sender, RoboSharp.EventArgObjects.ResultListUpdatedEventArgs e)
        {
